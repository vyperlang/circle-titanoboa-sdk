...
class TestChainConfigCompleteness:
    ...
    def test_all_chains_have_required_fields(self):
        ...
        for chain_name, config in CHAIN_CONFIGS.items():
            for field_name in ["chain_id", "name", "rpc_url", "usdc_address",
                               "gateway_address", "gateway_minter", "gateway_domain"]:
...
class TestSecurity:
    ...
    def test_signature_includes_nonce(self):
        ...
        requirements = PaymentRequirements(
            ...
            amount="10000", pay_to="0x1234567890123456789012345678901234567890",
...
class TestPaymentAmounts:
    ...
    def test_minimum_payment(self):
        ...
        requirements = PaymentRequirements(
            scheme="exact", network="eip155:5042002",
            asset="0x3600000000000000000000000000000000000000",
            amount="1", pay_to="0x1234567890123456789012345678901234567890",
            extra={"name": "GatewayWalletBatched", "version": "1",
                   "verifyingContract": "0x0077777d7EBA4688BDeF3E311b846F25870A19B9"}
        )
